...
/**
 * An image button with several image layers that can scroll if specified. The size of this image
...
/**
 * Creates an image button with the images and when to scroll. Be sure to call {@link
 * #addLayer(TextureAtlas, String, float)} to add images to this button.
 ...
 * @param imageName name of the image/layer (postfix should be 0-0) to get the correct coordinates
 */
