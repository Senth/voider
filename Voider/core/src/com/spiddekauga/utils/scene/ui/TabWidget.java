...
/** Inner scroll pane */
private ArrayList<ScrollPane> mScrollPanes = new ArrayList<>();@Override
public void layout() {
	// Update visibility
...
/**
 * Default constructor. <ul> <li>Widget alignment to top left</li> <li>Tab alignment to left</li>
 * <li>No margin</li> <li>No padding</li> <li>No background and fill height</li> </ul>
 */
public TabWidget() {
...
/**
 * Adds a new content tab which is scrollable. Automatically creates an anonymous hider
 ...
 * @pre a tab must have been added through any of the following methods as these action buttons are
 * only visible for this tab {@link #addTab(ImageButton, AlignTable)}, {@link #addTab(ImageButton,
 * AlignTable, HideListener)}, {@link #addTabScroll(ImageButton, AlignTable)}, or {@link
 * #addTabScroll(ImageButton, AlignTable, HideListener)}
...
/**
 * Add a global action button. This button is shown all the time if not hidden by another widget.
 * @param button the button to add
...
/**
 * Sets the tab location. If you changed the position from bottom or top to left or right (or vice
 * versa) you need to call either {@link #setAlignTab(Horizontal)} or {@link #setAlignTab(Vertical)}
 * if you want to use another alignment than the default one.
