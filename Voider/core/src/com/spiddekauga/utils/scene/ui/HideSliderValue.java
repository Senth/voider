...
/**
 * Creates a hide slider for the specified slider. To show the actors the slider needs to be in
 * [min,max] range. This will automatically add this HideSlideValue as a listener to the slider.
