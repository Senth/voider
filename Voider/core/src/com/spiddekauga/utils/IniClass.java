...
/**
 * Base class for all classes that are set from an ini-file. If the derived class has an inner class
 * (also derived from IniClass) and a variable of that inner-class, this variable will be
 * automatically set.
 */
...
/**
 * Get all declared inner classes for the specified class and all super classes, not including
 * IniClass. Only inner classes that are derived from the IniClass.
...
/**
 * Get all declared field from this class and all super-classes to and not including IniClass.
 ...
 * @return super class if it's derived from IniClass. null if super class is the IniClass itself
 */
@SuppressWarnings("unchecked")
...
/**
 * Set java class prefix. I.e. if any java class differ from the ini-file representation. E.g. If a
 * section is name [TextSettings] but the Java class name is IC_TextSettings the class prefix should
 * be set to "IC_".
