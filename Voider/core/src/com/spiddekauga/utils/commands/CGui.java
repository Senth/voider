 ...
 * @return true if the temporary name was set successfully, false if the actor already uses the
 * temporary name
 */
...
/**
 * Check if an GUI element can be combined (i.e. hasn't been too long since the values were change)
 * @return true if this GUI element can be combined with a newer one, false if too long time elapsed
 * since this command was executed
 */
