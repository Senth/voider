 ...
 * Changelog:
 * <p>
 * 09/22/08: Fixed Adler checksum calculation and byte order for storing length of zlib deflate
 * block. Thanks to Miloslav Ruzicka for noting this.
 * <p>
 * 05/12/09: Split PNG and ZLIB functionality into separate classes. Added support for images > 64K
 * by splitting the data into multiple uncompressed deflate blocks.
 * <p>
 * Terms of Use:
 * <p>
 * You may use the PNG encoder free of charge for any purpose you desire, as long as you do not
 * claim credit for the original sources and agree not to hold me responsible for any damage arising
 * out of its use.
 * <p>
 * If you have a suitable location in GUI or documentation for giving credit, I'd appreciate a
 * mention of
 * <p>
...
/**
 * Convert a pixmap to png bytes
 * @param pixmap the pixmap to export
 * @return bytes containing png data
 * @throws IOException
 */
