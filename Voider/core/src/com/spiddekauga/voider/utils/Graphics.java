...
/**
 * Create contour points from a picture. Based on <a href= "http://www.imageprocessingplace.com/downloads_V3/root_downloads/tutorials/contour_tracing_Abeer_George_Ghuneim/square.html"
 * >square tracing algorithm</a>
 * @param region the texture region to create the ship from
 * @param angleMin adjacent points that have less or equal angle (in degrees) to this will be
 * removed. 0 keeps the structure of the contour while removing all unnecessary points.
...
/**
 * Find a starting position for the contour algorithm. Finds the first fully opaque pixel.
