 ...
 * @throws ResourceNotFoundException if the resource doesn't got any revisions. I.e. it either does
 *                                   not exist, does not contain any revisions because it's either
 *                                   not a revision resource or it has been published.
 */
...
/**
 * Removes a resource (including all revisions) from the database and physically. Equivalent of
 * calling remove(resourceId, false), i.e. does not add the resource to the removed DB
...
/**
 * Removes all resources. Equivalent of calling {@link #removeAll(ExternalTypes)} with all external
 * types
 */
