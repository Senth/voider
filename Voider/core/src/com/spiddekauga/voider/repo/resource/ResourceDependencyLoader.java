...
/**
 * Checks whether the resources have been loaded and then if it has any dependencies that shall be
 * loaded. If so it will add these to the queue.
 ...
 * @note it will load the definition first, as it needs to read its dependencies which is in the
 * file.
 */
