...
/**
 * Save the specified resources. If the resource contains revisions it will try to upload it to the
 * server if the user is currently online.
...
/**
 * Synchronizes the user resource revisions, both upload and download and fixes conflicts
 * @param conflicts all conflicts to resolve
 * @param keepLocal how to resolve the conflicts. True if keep local versions, false if use server
 * versions.
 * @param progressListener download progress listener
 * @param responseListeners listens to the web response (when syncing is done)
 */
 ...
 * @param resourceId the resource to download again
 * @param revision specified revision of the user resource, if -1 it's a published resource
 * @param responseListener listens to the web response
 */
