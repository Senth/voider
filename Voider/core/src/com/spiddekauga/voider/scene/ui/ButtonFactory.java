 ...
 * @note that this text button will not use all the extra styles available in {@link
 * #addText(String, TextButtonStyles, AlignTable, ButtonListener, GuiHider, ArrayList)}
 */
 ...
 * @param vertical true for the checkboxes to be in a vertical layout, false for horizontal
