 ...
 * @param labelIsSection set to true if the label is a section (different styles are used for
 * true/false).
 ...
 * @return created error label. Can also be accessed via {@link #getLastCreatedErrorLabel()}
