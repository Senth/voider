...
/**
 * An optional settings menu for the editor. E.g. to switch between visuals and weapon settings in
 * enemy editor.
 */
...
/**
 * Run a command. If the editor isn't saved a message box is displayed that asks the player to
 * either save or discard the resource before executing the command.
...
/**
 * Run a command. Displays a message box that asks the player to either save or discard the
 * resources before executing the command.
 * @param command the command to run
 * @param title message box title
 * @param saveButtonText text for the save button then execute the command
 * @param withoutSaveButtonText text for the button when to just execute the command without saving
