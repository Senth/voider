...
/**
 * Constructs the command where the corner should be added. Will insert the corner at the back of
 * the corners.
 * @param resourceCorner the resource definition to add the corner to
 * @param cornerPos the corner position
 * @param resourceEditor editor to send IResourceChangeEditor.#onResourceChanged(IResource) event
 * to
 */
...
/**
 * Constructs the command where the corner should be added. Will created the corner at the specified
 * index position
 * @param resourceCorner the resource definition to add the corner to
 * @param cornerPos the corner position
