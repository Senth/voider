...
@Tag(49)
private ActorShapeTypes mType = null;
@Tag(60)
...
@Tag(63)
private List<Vector2> mCorners = new ArrayList<>();
@Tag(127)
private Vector2 mImageOffset = new Vector2();
@Tag(128)
private float mImageScaleWorld = 1;
@Tag(144)
private float mStartAngle = 0;
@Tag(157)
private DrawImages mDrawName = null;
@Tag(158)
...
/**
 * Array list of the polygon figure, this contains the vertices but not in triangles. Used for when
 * creating a border of some kind
 */
private List<Vector2> mPolygon = new ArrayList<>();
/**
 * Triangle vertices. To easier render the shape. No optimization has been done to reduce the number
 * of vertices.
 */
...
@Deprecated
@Tag(126)
private IImageNames unused1 = null;
...
/**
 * Sets the shape type of the enemy. This will clear the existing fixture shape for the enemy and
 * created another one with default values.
...
/**
 * Center the offset. This will set the offset to the middle of the fixture(s). It will NOT set the
 * center to (0,0) (only if the actual center of the fixtures are there.
 */
...
/**
 * Readjusts/fixes the fixtures for the custom shape would become too small. NOTE: When this
 * exception is thrown all fixtures have been removed and some might have been added. Fix the faulty
 * corner and call #fixCustomShapeFixtures() again to fix this.
 ...
 * @throws PolygonAreaTooSmallException    if some corners would create a triangle with too small
 *                                         area
 */
...
/**
 * @return triangle vertices for the current shape. Grouped together in groups of three to form a
 * triangle.
 */
