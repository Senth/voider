...
/**
 * Creates/Destroys bodies of the actors in the level. When an actor's body is destroyed the actor
 * will also be killed.
 */
...
/**
 * Checks whether the actor's body shall be killed or not All actors between minPos and maxPos will
 * have their bodies created. This method takes into account the size of the actor's fixtures.
