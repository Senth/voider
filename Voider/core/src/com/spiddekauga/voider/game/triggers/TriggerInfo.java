...
/**
 * Information for a trigger listener. This contains all the information to bind the listener to a
 * trigger.
 */
...
/**
 * Gets the specified listener's trigger for the specified trigger info. I.e. this will check in all
 * the listener triggers until it finds the specified trigger.
 ...
 * @return TriggerInfo that have the same triggerId and action as the specified trigger. Null if the
 * trigger info wasn't found inside the listener.
 */
...
/**
 * Tests whether this trigger info equals another trigger info in triggedId and action (i.e. it
 * doesn't test the delay).
...
/**
 * Gets the specified listeners's trigger for the specified trigger info. I.e. this will check in
 * all the listener triggers until it finds the trigger info with the specified action.
 * @param listener the enemy to find the TriggerInfo in.
