...
import com.spiddekauga.voider.user.RegisterUserServlet;
...
public class AccountChangeServlet extends VoiderApiServlet<AccountChangeMethod> {
...
private void changePassword() {
	...
	if (isUserPasswordCorrect(mParameters.oldPassword)) {
		...
		if (RegisterUserServlet.isPasswordLengthValid(mParameters.newPassword)) {
