...
/**
 * This method deletes backups older than 1 month and newer than 6 months, but keeps all backups
...
/**
 * Convert the backups to a list and filter out those that start on the 1st in the month, except if
 * they
