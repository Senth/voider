...
/**
 * Get the hash code for a specific array list. If the list is the maximum size an empty list hash
...
/**
 * Test equals on a list for a specific array. If any of the lists are of maximum sizes they will be
