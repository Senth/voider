...
public class Messages {
	...
	public enum EditorTooltips implements ITooltip {
		...
		// Tools
		TOOL_SELECTION("Selection tool (S)", "https://www.youtube.com/watch?v=7R1rK2b8jaU", 1),
		...
		TOOL_MOVE_LEVEL("Move tool (M)", "https://www.youtube.com/watch?v=UFmqy6YWMRk", 1),
		TOOL_MOVE_ACTOR(TOOL_MOVE_LEVEL.mText, TOOL_MOVE_LEVEL.mYoutubeLink, TAB_VISUAL, 2),
		TOOL_DELETE_LEVEL("Delete tool (Del)", "https://www.youtube.com/watch?v=96S2M17STaI", 1),
		...
		TOOL_DRAW_APPEND_TERRAIN("Draw terrain (D)", "https://www.youtube.com/watch?v=UbOF_KgpLzI", 1),
		TOOL_DRAW_ERASE_TERRAIN("Add/Remove area to/from terrain (Shift+D)", "https://www.youtube.com/watch?v=UbOF_KgpLzI", 1),
		...
		TOOL_DRAW_APPEND_ACTOR("Draw shape (T)", "https://www.youtube.com/watch?v=q9BmR6E5JvM", TAB_VISUAL, 2),
		TOOL_DRAW_ERASE_ACTOR("Add/Remove area to/from shape (Shift+T)", "https://www.youtube.com/watch?v=q9BmR6E5JvM", TAB_VISUAL, 2),
		TOOL_DRAW_CORNER_ADD_ACTOR("Add/Move shape corners (C)", "https://www.youtube.com/watch?v=q9BmR6E5JvM", TAB_VISUAL, 2),
		TOOL_DRAW_CORNER_REMOVE_ACTOR("Remove shape corners (Shift+C)", "https://www.youtube.com/watch?v=q9BmR6E5JvM", TAB_VISUAL, 2),
		TOOL_ENEMY_ADD("Add enemies (E)", "https://www.youtube.com/watch?v=n3d31c4gaf8", 1),
		TOOL_PATH("Add paths for enemies (P)", "https://www.youtube.com/watch?v=DWeUECW8o2w", 1),
		TOOL_TRIGGER_ACTIVATE("Set enemy activate triggers (T)", "https://www.youtube.com/watch?v=eCTuQdG3v98", 1),
		TOOL_TRIGGER_DEACTIVATE("Set enemy deactivate triggers (Shift+T)", "https://www.youtube.com/watch?v=eCTuQdG3v98", 1),
