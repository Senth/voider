...
public class BoundingBox {
	...
	/**
	 * Create a bounding box with values of 0. Same as calling {@link #BoundingBox(float)}
	 * with 0.
	 */
	public BoundingBox() {
		this(0);
	...
	/**
	 * Create bounding box with the specified values. Will set left and bottom to value;
	 * right and top to -value. I.e. an invalid bounding box
