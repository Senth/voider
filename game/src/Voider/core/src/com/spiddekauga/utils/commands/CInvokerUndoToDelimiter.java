...
/**
 * A command that undoes an specified invoker until the delimiter name is found. I.e. it
 * calls Invoker.undoToDelimiter(String,boolean)
...
public class CInvokerUndoToDelimiter extends Command {
	 ...
	 * @param addToRedoStack set to true if the undone commands should be added to the
	 *        redo stack
	 */
