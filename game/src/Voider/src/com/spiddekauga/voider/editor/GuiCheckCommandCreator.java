 ...
 * can be undone. This GUI check saves the previous state of the buttons, meaning
 * it always knows which button was previously checked even after it has been
 * unchecked.
 * 
 * @section Usage
...
public class GuiCheckCommandCreator implements EventListener {
	/**
	 * Creates an empty GuiCheckeCommandCreator with the specified invoker to
	 * send commands to.
