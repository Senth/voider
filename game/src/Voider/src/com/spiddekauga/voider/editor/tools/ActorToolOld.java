 ...
 */
public abstract class ActorToolOld extends TouchTool implements ISelectTool {
	/**
	 ...
	 */
	public ActorToolOld(Camera camera, World world, Invoker invoker, Class<?> actorType) {
