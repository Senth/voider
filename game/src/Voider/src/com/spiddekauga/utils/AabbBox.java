...
public class AabbBox {
	...
	/**
	 * Sets the AABB box from a box, but uses a center position and
	 * with/height to determine minimum/maxiumum positions
	...
	/**
	 * Sets the AABB box from a polygon. Traverses through all vertices to get the
